    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/productos" element={<ProductosBuscar />} />
          <Route path="/productos/:nombre" element={<ProductoDescripcion />} />
          <Route path="/productos/:nombre/comprar" element={<ProductoComprar />} />
